#
#  Be sure to run `pod spec lint LBPay.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "罗博"
  # spec.authors            = { "罗博" => "boluo1992@126.com" }
  # spec.social_media_url   = "https://twitter.com/罗博"
